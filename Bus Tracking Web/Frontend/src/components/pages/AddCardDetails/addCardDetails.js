...
class AddStudent extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(`${APIURL}/TopupPayment/getAllTopListbyID/${TopUpID}`)
        ...
        <div>
          <div>
            ...
            <div className="v318_65">
              ...
              <span className="v318_69">Travel Buddy is here to help you to make your travel desires easier more than ever</span><span className="v318_70"></span>
              ...
              <div className="v318_101">
                <span className="v318_102">    <input type="number" id="fname" placeholder="Card Number"
                  name="cardnumber"
              ...
              <div className="v318_107">
                <span className="v318_108"><input type="number" id="fname" placeholder="Amount"
                  name="amount"
              ...
              <div className="v318_114">
                <span className="v318_115"><input type="number" id="fname" placeholder="CVV"
                  name="cvv"

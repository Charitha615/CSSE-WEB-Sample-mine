  ...
  render() {
    ...
    return (
      <>
        ...
        <div>
          <div>
            <p className="v75:145">Sign Up
            </p>
            <div className="v318_65">
              <div className="v318_66" />
              <div className="v318_67" />
              <span className="v318_68">Links</span>
              <span className="v318_69">Travel Buddy is here to help you to make your travel desires easier more than ever</span><span className="v318_70">&gt; FAQ</span>
              <span className="v318_71">&gt; Help</span>
              <span className="v318_72">travelbuddy@gmail.com
                072 345 55 66</span>
              ...
              <span className="v318_81">Travel Buddy</span><div className="v318_82" />
              <span className="v318_83">Status : Payment Pending</span>
              <span className="v318_84">*Please top up your card to procced</span>
              <div className="name" /><span className="v318_86">My Recent Trip</span>
              <span className="v318_87">02/09/2021  from Kandy to Kurunegala</span>
              <span className="v318_88">Home&gt;Payments</span>
              <span className="v318_89">02/09/2021  from Kandy to Kurunegala</span>
              ...
              <span className="v318_95">Rs. 500.00</span>
              ...
              {/* <span className="v318_100">Home&gt;Payments</span> */}
              <div className="v318_101">
                <span className="v318_102">    <input type="text" id="fname" placeholder="Card Number"
                  name="cardnumber"
              ...
              <div className="v318_103">
                <span className="v318_104"><input type="text" id="fname" placeholder="Card Name"
                  name="cardname"
              ...
              <div className="v318_107">
                <span className="v318_108"><input type="text" id="fname" placeholder="Amount"
                  name="amount"
              ...
              <div className="v318_112">
                <span className="v318_113"><input type="text" id="fname" placeholder="MM/DD"
                  ...
                  onChange={this.onChange}
                  required
                  style={{ width: "158px", height: "46px", marginTop: "-20px", marginLeft: "-5px" }}
                /></span>
              </div>
              <div className="v318_114">
                <span className="v318_115"><input type="text" id="fname" placeholder="CVV"
                  name="cvv"
              ...
              <div className="name" /><span className="v318_121">Account ID</span>
              ...
              <span className="v318_128">Rs. 500.00</span>
              <span className="v318_129">Latest Payment Date</span>
              <span className="v318_130">05-Sept-2021</span>
              <span className="v318_131">Current Balance</span>
              {/* <span className="v318_131">Current Balance</span> */}

              <span className="v318_132">Rs. 200.00</span>
